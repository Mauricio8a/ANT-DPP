...
<div class="container" id="main">
	...
	<?php
          	$query0 = "SELECT * FROM personas WHERE cedula='$cedula'";
          	$result0 = $my_sqli->query($query0);
          	$line = mysqli_fetch_row($result0);
  ?>
            <div class="row">
            	<div class="col-md-6">
            		<div>Datos de C.I.: <strong><?php echo $line[1]; ?></strong></div>
            		<div>Apellidos/Nombres: <strong><?php echo $line[3] . " " . $line[2]; ?></strong></div>
            		<div>Email: <strong><?php echo $line[7]; ?></strong></div>
            		<div>Cargo: <strong><?php echo $line[6]; ?></strong></div>
            		<div>Teléfono: <strong><?php echo $line[5]; ?></strong></div>
            		<div>Dirección: <strong><?php echo $line[4]; ?></strong></div>
            	</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel"><i class="fas fa-desktop"></i><strong>&nbsp;&nbsp;Actualización de Datos</strong></h5>
        ...
        <form name="edita_usu" action="actualiza_usuario.php" method="post" enctype="multipart/form-data">
             <div class="form-row"> 
              <div class="form-group col-md-6">
                ...
                <input type="form-text" class="form-control" id="cedula" name="cedula" value="<?php echo $line[1];?>" pattern="^[0-9]+" minlength="10" maxlength="10" required>
              </div>
             </div> 
             <div class="form-row"> 
              <div class="form-group col-md-6">
                <label for="cedula">Apellidos</label>
                <input type="form-text" class="form-control" id="apellidos" name="apellidos"  value="<?php echo $line[3];?>"  minlength="1" maxlength="70" required>
              </div>
              <div class="form-group col-md-6">
             ...
             <div class="form-row"> 
              <div class="form-group col-md-6">
                ...
                <input type="form-text" class="form-control" id="cargo" name="cargo" value="<?php echo $line[6];?>"  maxlength="70" required>
              </div>
              <div class="form-group col-md-6">
                <label for="email">Email</label>
                <input type="email" class="form-control" id="email" name="email" value="<?php echo $line[7];?>" pattern="^[\w.\w]+@ant.gob.ec" maxlength="128" placeholder="@ant.gob.ec" required>
             ...
             <div class="form-row"> 
              <div class="form-group col-md-6">
                ...
                <input type="form-text" class="form-control" value="<?php echo $line[4];?>" id="direccion" name="direccion" maxlength="70" required>
              </div>
              <div class="form-group col-md-6">
